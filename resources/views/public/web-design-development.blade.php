...
<title>Website Design &amp; Development — SEO AI Co™</title>
<meta name="description" content="Custom website design and development services from SEO AI Co™ — performance-focused builds and redesigns aligned with programmatic local SEO expansion.">
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    {
      "@type": "WebPage",
      "name": "Website Design & Development — SEO AI Co™",
      "url": "{{ url('/web-design-development') }}",
      "breadcrumb": {
        "@type": "BreadcrumbList",
        "itemListElement": [
          {"@type":"ListItem","position":1,"name":"Home","item":"{{ url('/') }}"},
          {"@type":"ListItem","position":2,"name":"Growth Services","item":"{{ url('/growth-services') }}"},
          {"@type":"ListItem","position":3,"name":"Web Design & Development","item":"{{ url('/web-design-development') }}"}
        ]
      }
    },
    {
      ...
      "description": "Custom website design and development, performance-focused builds, landing pages, and redesigns for local service businesses expanding through programmatic SEO.",
      "url": "{{ url('/web-design-development') }}",
...
<main class="page">
  ...
  <span class="page-eye">Development &amp; Design</span>
  <h1 class="page-title">Websites built to<br><em>expand with you.</em></h1>
  <p class="page-intro">Every website we build or redesign is structured around one principle — your visibility needs to grow. Performance, architecture, and design aligned with your programmatic SEO expansion, not built in isolation from it.</p>

  <div class="features">

    <div class="feature">
      <span class="feat-label">New Builds</span>
      <h2 class="feat-hed">Custom website design and development.</h2>
      <p class="feat-copy">Full custom builds for local service businesses, agencies, and emerging operators. <strong>Performance-first architecture.</strong> Clean, semantic HTML structured for search and AI discovery. Mobile-first, fast, and aligned with your market strategy.</p>
    </div>

    <div class="feature">
      <span class="feat-label">Redesigns</span>
      <h2 class="feat-hed">Redesigns that improve position, not just appearance.</h2>
      <p class="feat-copy">Existing sites modernized for current search standards. <strong>Speed, structure, and content hierarchy</strong> reviewed against your expansion goals. Not aesthetic-only — built to rank and convert.</p>
    </div>

    <div class="feature">
      <span class="feat-label">Landing Pages</span>
      <h2 class="feat-hed">Conversion-focused landing experiences.</h2>
      <p class="feat-copy">Standalone landing pages for campaigns, services, and market entries. <strong>Designed for clarity and conversion</strong> — aligned with your local SEO strategy, not generic templates.</p>
    </div>

    <div class="feature">
      <span class="feat-label">Technical Alignment</span>
      <h2 class="feat-hed">Built for AI search infrastructure compatibility.</h2>
      <p class="feat-copy">Every build uses semantic structure, correct heading hierarchy, schema markup, fast-loading assets, and clean internal linking — all foundational requirements for <strong>AI-aware search discovery and local ranking performance.</strong></p>
    </div>

  </div>

  <div class="page-cta">
    <p>Website work is most effective when aligned with your programmatic SEO expansion. Explore market availability first, then discuss build scope.</p>
    <a href="{{ route('onboarding.start') }}" class="cta-btn">Check Market Availability</a><br>
    <a href="/#contact" class="cta-ghost">Request a Build Consultation</a>
  </div>
  ...
  <div class="ai-note">
    <strong>About this service:</strong> SEO AI Co™ provides website design and development for local service businesses. Services include custom website builds, site redesigns, and landing page development. All builds are structured for compatibility with programmatic local SEO infrastructure, semantic HTML standards, and AI-assisted search discovery. Website development is offered as an execution service alongside the core SEO AI Co™ programmatic expansion platform.
  </div>
