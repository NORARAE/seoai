...
<meta name="theme-color" content="#080808">
    ...
    <title>Payment Confirmed — Welcome Aboard | SEO AI Co™</title>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        h1{font-size:2rem;font-weight:600;margin-bottom:.75rem;color:#c8a84b}
...
<body>
    <div class="card">
        ...
        <p>Your license key is being generated and will arrive by email within a few minutes.</p>
        <div class="key-note">
            Copy the license key from your email and paste it into<br>
            <strong>Settings &rarr; Content Engine &rarr; License Key</strong><br>
