...
{!! json_encode([
    ...
    '@graph' => [
        [
            ...
            'url'         => url('/pricing'),
            'name'        => 'AI Citation Engine™ Pricing — Get Cited by AI',
            'description' => 'Choose your AI citation plan. SEO AI Co™ structures your content for citation by Google AI Overviews, ChatGPT, Perplexity, and Gemini.',
            'breadcrumb'  => [
                '@type' => 'BreadcrumbList',
                'itemListElement' => [
        ...
        [
            ...
            'mainEntity' => [
                [
                    '@type' => 'Question',
                    'name'  => 'What is AI citation?',
                    'acceptedAnswer' => [
                        '@type' => 'Answer',
                        'text'  => 'AI citation is when an AI system — like Google AI Overviews, ChatGPT, or Perplexity — pulls content from your site and cites it as a source in a generated answer. Unlike ranking, citation means your content is the answer, not just a result near the answer.',
                    ],
                ],
                [
                    '@type' => 'Question',
                    'name'  => 'How is the AI Citation Engine™ different from SEO?',
                    'acceptedAnswer' => [
                        '@type' => 'Answer',
                        'text'  => 'Traditional SEO optimizes for ranking positions in search results. The AI Citation Engine™ structures your content so AI systems extract and cite it in generated answers — a different technical and strategic discipline. Citation captures query intent at the moment of answer selection, not just at the moment of search.',
                    ],
                ],
                [
                    '@type' => 'Question',
                ...
                [
                    '@type' => 'Question',
                    'name'  => 'Who is the AI Citation Engine™ for?',
                    'acceptedAnswer' => [
                        '@type' => 'Answer',
                        'text'  => 'The AI Citation Engine™ is built for local service businesses, agencies, and multi-location brands that want to be the source AI systems recommend — not just a result that appears below an AI-generated answer. If your customers are asking AI tools who to hire, you need to be the answer those tools return.',
                    ],
                ],
            ],
        ],
