...
<div style="max-width:560px;margin:40px auto;background:#ffffff;overflow:hidden;border:1px solid #e8e8e8">
  ...
  <div style="padding:28px 24px">
    ...
    <div style="text-align:center;margin:24px 0">
      <a href="{{ url('/checkout/signal-expansion') }}" style="display:inline-block;padding:14px 36px;background:#080808;color:#ede8de;font-size:13px;letter-spacing:.1em;text-decoration:none;text-transform:uppercase">Unlock Signal Expansion &mdash; $99</a>
    </div>

    <p style="font-size:12px;color:#999;line-height:1.6;margin:20px 0 0;text-align:center">Or <a href="{{ url('/book') }}" style="color:#c8a84b;text-decoration:none">book a free strategy call</a> to talk through your options.</p>
  </div>
