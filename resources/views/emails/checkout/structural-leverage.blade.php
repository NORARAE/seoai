...
<div style="max-width:560px;margin:40px auto;background:#ffffff;overflow:hidden;border:1px solid #e8e8e8">
  ...
  <div style="background:#080808;padding:28px 24px;text-align:center">
    ...
    <p style="font-size:10px;letter-spacing:.18em;text-transform:uppercase;color:rgba(200,168,75,.5);margin:6px 0 0">Action Plan</p>
  </div>
  ...
  <div style="padding:28px 24px">
    ...
    <p style="font-size:13px;color:#555;line-height:1.7;margin:0 0 20px">We&rsquo;re building your complete priority correction sequence &mdash; every fix prioritized by ROI, every opportunity sized, every gap closed systematically. Your dashboard will update with the action sequence as processing completes.</p>
    ...
    <p style="font-size:12px;color:#999;line-height:1.6;margin:20px 0 0">We&rsquo;ll email you when your dashboard sequence is ready. In the meantime, no action is needed on your part.</p>
  </div>
  ...
  <div style="background:#fafaf8;padding:20px 24px;border-top:1px solid #e8e8e8;text-align:center">
    ...
    <a href="{{ \App\Support\EmailUrl::tracked('/checkout/system-activation', 'checkout-structural-leverage') }}" style="display:inline-block;padding:12px 28px;background:#080808;color:#ede8de;font-size:12px;letter-spacing:.1em;text-decoration:none;text-transform:uppercase">Start Guided Execution &mdash; $489</a>
  </div>
