...
<div style="max-width:560px;margin:40px auto;background:#ffffff;overflow:hidden;border:1px solid #e8e8e8">
  ...
  <div style="padding:32px 28px">
    ...
    <div style="text-align:center;margin:20px 0">
      <a href="{{ \App\Support\EmailUrl::tracked('/checkout/signal-expansion', 'quick-scan-day2', $scan->user_id, $scan->id) }}" style="display:inline-block;background:#c8a84b;color:#080808;font-size:12px;font-weight:600;text-decoration:none;padding:13px 36px;letter-spacing:.08em">Upgrade to Signal Analysis &mdash; $99</a>
    </div>

    <p style="font-size:12px;color:#bbb;text-align:center;margin:16px 0 0">
      Or <a href="{{ \App\Support\EmailUrl::tracked('/book', 'quick-scan-day2', $scan->user_id, $scan->id) }}" style="color:#c8a84b;text-decoration:none">book a free strategy call</a> to talk through your score.
    </p>
  </div>
