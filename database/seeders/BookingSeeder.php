...
class BookingSeeder extends Seeder
{
    public function run(): void
    {
        $types = [
            ...
            ['name' => 'Market Clarity Session', 'slug' => 'discovery', 'description' => 'See exactly where your visibility is being lost — and why.', 'duration_minutes' => 20, 'price' => null, 'is_free' => true, 'is_active' => true, 'sort_order' => 1],
            ...
            ['name' => 'Market Control Deployment', 'slug' => 'agency-review', 'description' => 'Deploy the system that reshapes how your business is found across markets.', 'duration_minutes' => 60, 'price' => 250.00, 'is_free' => false, 'is_active' => true, 'sort_order' => 3],
